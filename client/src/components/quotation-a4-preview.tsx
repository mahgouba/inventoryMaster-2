      ...
      >
        ...
        <div className="absolute inset-0 p-8">
          ...
          <div className="mb-[11px] ml-[25px] mr-[25px]" style={{marginTop: '38px'}}>
            ...
            {/* Vehicle Information */}
            {selectedVehicle && (
              <div className="relative p-4 w-full mt-[166px] mb-[16px] overflow-hidden bg-[#fafafa12] text-[#050505f2]">
...
<div className="mt-3 pt-3">
          ...
          <div className="bg-white/90 print:bg-white border border-white rounded mb-6 shadow-sm">
            ...
            {/* Total Row */}
            <div className="p-4 bg-gray-50 print:bg-white border-t-2 border-white rounded-b pt-[4px] pb-[4px]">
