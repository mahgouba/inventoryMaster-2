...
<div className="mt-3 pt-3">
          ...
          {companyStamp && (
            <div className="flex justify-end mb-6">
              <div className="bg-transparent border border-gray-300 p-4 rounded shadow-sm w-80 pl-[2px] pr-[2px] pt-[2px] pb-[2px]">
                <div className="border-2 border-dashed border-gray-300 h-40 flex items-center justify-center rounded bg-transparent">
                  <img 
                    src={companyStamp} 
                    alt="ختم الشركة" 
                    className="w-full h-full object-contain"
