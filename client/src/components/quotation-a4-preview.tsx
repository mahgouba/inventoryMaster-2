        ...
        <div className="absolute inset-0 p-8">
          ...
          <div className="relative mb-8">
            ...
            <div className="absolute top-20 right-8">
              ...
              <div className="mt-4 bg-white/90 border border-gray-300 p-3 rounded shadow-sm pt-[1px] pb-[1px] text-[13px] text-right">
          ...
          <div className="mb-8 ml-[25px] mr-[25px]" style={{marginTop: '38px'}}>
            

            {/* Vehicle Information */}
            {selectedVehicle && (
              <div className="bg-white/90 border border-gray-300 p-4 rounded shadow-sm w-full mt-[166px] mb-[166px]">
