      ...
      >
        ...
        <div className="absolute inset-0 p-8">
          ...
          <div className="mb-[11px] ml-[25px] mr-[25px]" style={{marginTop: '38px'}}>
            ...
            {/* Vehicle Information */}
            {selectedVehicle && (
              <div className="relative p-4 w-full mt-[166px] mb-[16px] overflow-hidden print:bg-transparent border border-[#E2E8F0] rounded-lg shadow-lg print:border-none pl-[18px] pr-[18px] ml-[-22px] mr-[-22px]"></div>
