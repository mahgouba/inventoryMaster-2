      ...
      try {
        ...
        const mappedData = dataRows.map((row: any[], index: number) => {
          return {
            ...
            price: row[9] ? parseFloat(row[9]) : 0,
            ...
            // Remove these fields as requested by user:
            // serialNumber will be auto-generated by server
            // fuelType, transmission will use default values
            fuelType: 'بنزين', // Set default value
            transmission: 'أوتوماتيك', // Set default value
          };
        });
