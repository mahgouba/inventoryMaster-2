                        ...
                        <div className="w-full space-y-4 animate-in slide-in-from-top-2 duration-300">
                          ...
                          <div className="flex justify-center mb-4">
                            <Button
                              ...
                              className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-6 py-3 rounded-xl flex items-center gap-3 shadow-lg hover:shadow-xl transition-all duration-300 backdrop-blur-sm border border-white/20"
                            >
