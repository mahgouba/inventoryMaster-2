...
import { User, Copy, Share2 } from 'lucide-react';
...
export default function BanksPersonal() {
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      {bank.logo ? (
                        ...
                        <div className="h-14 w-14 bg-purple-500/20 backdrop-blur-sm rounded-xl flex items-center justify-center border border-purple-400/30">
                      ...
                      <Button
                        ...
                        className="bg-purple-500/20 hover:bg-purple-500/30 border border-purple-400/30 text-purple-300 backdrop-blur-sm"
                      >
