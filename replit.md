...
- **Role-Based Access Control (RBAC)**: Comprehensive permissions system for admin, sales_director, inventory_manager, bank_accountant, accountant, and salesperson roles, dynamically adapting UI and navigation based on role-specific permissions.
