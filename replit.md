...
- July 14, 2025: Cleaned up quotation interface - removed "Show Sold Cars" button from card view, removed "إدارة بيانات الشركة" button from quotation creation page, and reorganized license plate section in quotation preview to appear after tax row instead of separate row for better pricing structure clarity
```
